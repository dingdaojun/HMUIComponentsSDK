...
- (BOOL)isEqualToDateIgnoringTime:(NSDate *)anotherDate {
    ...
    NSDateComponents *components2 = [calendar components:componentFlags fromDate:anotherDate];
...
- (BOOL)isSameWeekAsDate:(NSDate *)anotherDate {
    NSDateComponents *components1 = [[NSCalendar gregorianCalendar] components:componentFlags fromDate:self];
...
- (BOOL)isNextYear {
    NSCalendar *calendar = [NSCalendar gregorianCalendar];
    NSDateComponents *components1 = [calendar components:NSCalendarUnitYear fromDate:self];
    NSDateComponents *components2 = [calendar components:NSCalendarUnitYear fromDate:[NSDate date]];
