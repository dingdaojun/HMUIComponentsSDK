...
4. We also provide category which connected with bussiness AppCategory, for example: HMCategoryMifitKit, HMCategoryHealthKit.
  ...
  s.subspec 'Base' do |base|
    base.source_files = 'HMCategoryKit/HMCategoryDefine.h'
    base.private_header_files = 'HMCategoryKit/HMCategoryDefine.h'
  end

  s.subspec 'HMCategoryKit' do |ss|

    ss.source_files = 'HMCategoryKit/HMCategoryKit.h'
    ss.dependency 'HMCategory/Base'
    ...
    ss.subspec 'FoundationKit' do |foundation|
        ...
        foundation.subspec 'NSDateFormatter' do |formatter|
            formatter.source_files = 'HMCategoryKit/FoundationKit/NSDateFormatter/*'
        end
        foundation.subspec 'NSData' do |data|
            data.source_files = 'HMCategoryKit/FoundationKit/NSData/*'
        end
        foundation.subspec 'NSDate' do |date|
            date.dependency 'HMCategory/HMCategoryKit/FoundationKit/NSDateFormatter'
            date.source_files = 'HMCategoryKit/FoundationKit/NSDate/*'
        end
        foundation.subspec 'NSDictionary' do |dictionary|
            dictionary.dependency 'HMCategory/HMCategoryKit/FoundationKit/NSDateFormatter'
        ...
        foundation.subspec 'NSCalendar' do |calendar|
            calendar.source_files = 'HMCategoryKit/FoundationKit/NSCalendar/*'
        end
        ...
        foundation.subspec 'NSString' do |string|
            string.dependency 'HMCategory/HMCategoryKit/FoundationKit/NSDateFormatter'
