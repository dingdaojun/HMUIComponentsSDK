...
@property (readonly) NSString *api_userNickName;
@property (readonly) NSDate *api_userBirthday;
@property (readonly) HMServiceAPIUserGender api_userGender;

@property (readonly) NSString *api_userAvatarURL;

@property (readonly) double api_userHeight;
@property (readonly) double api_userWeight;
