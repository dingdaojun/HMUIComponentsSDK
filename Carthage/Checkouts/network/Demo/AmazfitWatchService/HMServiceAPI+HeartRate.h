...
@property (readonly) NSDate *api_heartRateDataTime;
@property (readonly) Byte api_heartRateDataValue;
@property (readonly) HMServiceAPIDeviceSource api_heartRateDataDeviceSource;
@property (readonly) NSString *api_heartRateDataDeviceID;
...
- (id<HMCancelableAPI>)heartRate_listToDate:(NSDate *)date
