...
@property (readonly) NSString *api_thirdPartyAccessDataAppID;                  //开放平台中的appid
@property (readonly) NSString *api_thirdPartyAccessDataUserID;                 //三方的userID
@property (readonly) NSString *api_thirdPartyAccessDataAccessToken;            //三方的AccessToken
@property (readonly) NSString *api_thirdPartyAccessDataNickName;               //三方的昵称
@property (readonly) NSTimeInterval api_thirdPartyAccessDataExpiresTime;     //三方的有效时长
