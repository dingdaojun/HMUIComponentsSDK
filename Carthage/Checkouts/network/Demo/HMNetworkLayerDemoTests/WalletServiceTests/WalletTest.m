...
- (void)testProtocolNew {
    ...
    XCTestExpectation *expectation = [self expectationWithDescription:@"testProtocolNew"];
    HMServiceAPI *serviceAPI = [HMServiceAPI defaultService];
    id<HMCancelableAPI>api = [serviceAPI wallet_protocolWithXiaomiCardName:@"ZHENGZHOU"
                                                              protocolType:@"xiaomi_accesscard"
                                                               acctionType:@"UPDATE"
                                                                   appCode:@""
                                                           completionBlock:^(NSString *status, NSString *message, id<HMServiceAPIWalletProtocol> protocol) {
...
- (void)testConfirmProtocol {
    ...
    HMServiceAPI *serviceAPI = [HMServiceAPI defaultService];
    id<HMCancelableAPI>api = [serviceAPI wallet_confirmProtocolWithID:@"201807311912"
                                                      completionBlock:^(NSString *status, NSString *message) {
...
- (void)testConfirmProtocolNew {
    
    XCTestExpectation *expectation = [self expectationWithDescription:@"testConfirmProtocolNew"];
    HMServiceAPI *serviceAPI = [HMServiceAPI defaultService];
    id<HMCancelableAPI>api = [serviceAPI wallet_confirmProtocolWithID:@"201807311912"
                                                         protocolType:@"xiaomi_accesscard"
                                                      completionBlock:^(NSString *status, NSString *message) {
                                                            XCTAssertEqualObjects(status, @"0000");
                                                            XCTAssertEqualObjects(message, @"success");
...
- (void)testAcessCards {
    ...
    HMServiceAPI *serviceAPI = [HMServiceAPI defaultService];
    id<HMCancelableAPI>api = [serviceAPI wallet_acessCardWithQueryType:@"0"
