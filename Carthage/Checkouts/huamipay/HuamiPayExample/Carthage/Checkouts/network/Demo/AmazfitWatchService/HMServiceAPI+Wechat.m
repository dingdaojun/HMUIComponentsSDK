...
#import "HMServiceAPI+Wechat.h"
#import <HMNetworkLayer/HMNetworkLayer.h>


@interface NSDictionary (HMServiceAPIWechatAuthorizeData) <HMServiceAPIWechatAuthorizeData>
@end

@implementation NSDictionary (HMServiceAPIWechatAuthorizeData)

- (BOOL)api_wechatAuthorizeDataBound {
    return self.hmjson[@"isbind"].boolean;
}

-(NSString *)api_wechatAuthorizeDataNickname {
...
@implementation HMServiceAPI (Wechat)
