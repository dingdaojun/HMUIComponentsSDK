...
typedef NS_ENUM(NSUInteger, HMServiceAPIConfigurationSportDisplayItemType) {
    ...
    HMServiceAPIConfigurationSportDisplayItemCurrentGroupCount                       = 255, // 当前组数(跳绳)
    HMServiceAPIConfigurationSportDisplayItemThisGroupCount                          = 256, // 本组计数(跳绳)
    HMServiceAPIConfigurationSportDisplayItemThisGroupCostTime                       = 257, // 本组用时(跳绳)
    HMServiceAPIConfigurationSportDisplayItemThisGroupAverageFrequency               = 258  // 本组平均频率(跳绳)
};
...
//@property (readonly) HMServiceAPIConfigurationIntervalRunDeviceType api_configurationIntervalRunDeviceType;
...
// 透传信息
@property (readonly) NSString *api_configurationOpaqueHealth;
@property (readonly) NSString *api_configurationOpaqueSport;
@property (readonly) NSString *api_configurationOpaqueMedal;
@property (readonly) NSString *api_configurationOpaqueWearSettings;
