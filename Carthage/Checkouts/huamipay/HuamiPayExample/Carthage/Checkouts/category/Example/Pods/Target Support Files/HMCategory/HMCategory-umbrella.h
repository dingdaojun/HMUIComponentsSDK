...
#import "UILabel+HMLocalizableFlips.h"
...
#import "HMCategoryMifitKit.h"

FOUNDATION_EXPORT double HMCategoryVersionNumber;
FOUNDATION_EXPORT const unsigned char HMCategoryVersionString[];
