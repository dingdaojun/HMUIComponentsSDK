...
@interface HMDBWeatherAQIRecord : CTPersistanceRecord

@property (copy, nonatomic)   NSNumber      *identifier;                 // 数据库自生成主键，无实际意义
@property (copy, nonatomic)   NSString      *weatherAQIPublishTime;      // 空气质量发布时间
@property (assign, nonatomic) NSInteger     valueOfAQI;                  // 空气质量数值
