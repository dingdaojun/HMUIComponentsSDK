...
- (void)testRetrieving {
    ...
    NSDate *date = [NSDate dateFromFormateString:@"2017-5-18 00:00:00" dateFormat:HMDateFormatyyyy_MM_ddsHHcmmcss];
...
- (void)testGenerate {
    ...
    if ([NSLocale isChinaRegion]) {
        XCTAssertNotNil([NSDate dateFromFormateString:@"2017-05-17 17:21 下午" dateFormat:HMDateFormatyyyy_MM_ddsHHcmmsa]);
        XCTAssertNotNil([NSDate dateFromFormateString:@"17:21 下午" dateFormat:HMDateFormatHHcmmsa]);
    } else {
