...
public class PayCityGuangxi: PayCityBase, CityCardApduProtocol {
    public static var miCardName: String { return "GUANGXI" }
    public static var aid: Data { return Data.init(hex: "A00000063201010553004755414E4758") }
    public static var miFetchModel: String { return "SYNC" }
    public static var cityName: String { return "广西" }
    public static var cityCode: String { return "9002" }
    ...
    public func setDefault(_ non: Bool, for city: PayCity) throws {
        try setDefault(non, aid: PayCityGuangxi.aid)
    }
    ...
    public func isDefault() throws -> Bool {
        return try isDefault(PayCityGuangxi.aid)
    }
}

extension PayCityGuangxi {
...
extension PayCityGuangxi {
    ...
    func select() throws {
        // select
        let selRes = try PayTransmit.shared.transmit(PayCityBase.select(PayCityGuangxi.aid))
