...
typedef NS_ENUM(NSUInteger, HMServiceAPIDeviceSource) {
    ...
    HMServiceAPIDeviceSourceWatchQogir      = 403,      // Qogir手表

    HMServiceAPIDeviceSourceCoreMotion      = 7,        // iOS CoreMotion
};
// 如果断言崩溃请联系lixian@huami.com
#define HMServiceAPIDeviceSourceParameterAssert(x)  \
NSParameterAssert(x == HMServiceAPIDeviceSourceBand1 ||    \
...
x == HMServiceAPIDeviceSourceWatchEverest2S ||     \
x == HMServiceAPIDeviceSourceWatchQogir ||     \
