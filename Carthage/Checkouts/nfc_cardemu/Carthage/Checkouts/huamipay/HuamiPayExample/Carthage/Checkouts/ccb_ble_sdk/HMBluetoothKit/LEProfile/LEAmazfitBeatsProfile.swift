//
//  LEAmazfitBeatsProfile.swift
//  HMBluetoothKit
//
//  Created by 余彪 on 2018/4/18.
//

import Foundation

public class LEAmazfitBeatsProfile: Profile {
...
extension LEAmazfitBeatsProfile: AuthProtocol {
...
extension LEAmazfitBeatsProfile: RealtimeSensorDataProtocol {
...
extension LEAmazfitBeatsProfile: ActivityDataProtocol {
...
extension LEAmazfitBeatsProfile: GenericProtocol {
...
extension LEAmazfitBeatsProfile: FirmwareUpdateProtocol {
...
extension LEAmazfitBeatsProfile: ECFProtocol {
