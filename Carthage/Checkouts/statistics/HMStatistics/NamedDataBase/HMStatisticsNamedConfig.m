...
@implementation HMStatisticsNamedConfig
...
+ (BOOL)clearDatabase {
    ...
    NSString *databaseFilePath = [dir stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.sqlite", [HMStatisticsNamedConfig dataBaseName]]];

    NSError *error = nil;
    NSFileManager *fileManager=[NSFileManager defaultManager];

    // 关闭数据库连接
    [[CTPersistanceDatabasePool sharedInstance] closeDatabaseWithName:[HMStatisticsNamedConfig dataBaseName]];
